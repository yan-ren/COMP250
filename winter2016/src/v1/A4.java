...
*/
		 ...
		 * tow arrayList are for traversing the tree
		 */
		...
		while(true){			
			...
			//create next level of tree by analysing each node in current level
	...
	//check Triplets that satisfy W or B-substitution 
